...
export const clientesSchema = z.object({
    cedula: z.string().min(7, "La cedula debe tener al menos 7 caracteres validos").max(9, "La cedula no puede tener mas de 9 caracteres"),
...
export const updateClientesSchema = z.object({
    cedula: z.string().min(7, "La cedula debe tener al menos 7 caracteres validos").max(9, "La cedula no puede tener mas de 9 caracteres").optional(),
