...
export const clientesSchema = z.object({
    ...
    telefono: z.string().min(7, "El telefono debe tener al menos 7 caracteres validos").max(15, "El telefono no puede tener mas de 15 caracteres").optional().nullable().or(z.literal("")),
    email: z.string().email("El correo electrónico debe ser válido").optional().nullable().or(z.literal("")),
